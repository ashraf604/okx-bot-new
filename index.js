// =================================================================
// OKX Advanced Analytics Bot - v92 (Definitive Stable Merge)
// =================================================================
...
// --- RESTORED: Full Quick Stats Function ---
...
const mainKeyboard = new Keyboard()
    ...
    .text("⚡ إحصائيات سريعة").text("🔔 ضبط تنبيه").row()
    .text("🧮 حاسبة الربح والخسارة").text("⚙️ الإعدادات").resized();
...
bot.command("start", (ctx) => {
    const welcomeMessage = `🤖 *أهلاً بك في بوت OKX التحليلي المتكامل، مساعدك الذكي لإدارة وتحليل محفظتك الاستثمارية.*\n\n` +
        `*الإصدار: v92 - The Real Final Version*\n\n` +
        `تم دمج جميع الميزات بشكل صحيح هذه المرة.`;
...
async function startBot() {
    try {
        ...
        setInterval(monitorVirtualTrades, 30 * 1000); // NEW
