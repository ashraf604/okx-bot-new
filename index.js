// =================================================================
// OKX Advanced Analytics Bot - v34 (Professional Summary)
// =================================================================
// هذا الإصدار يضيف مؤشرات احترافية لملخص المحفظة.
// =================================================================
    ...
    try {
        ...
        tickersJson.data.forEach(t => {
            prices[t.instId] = {
                ...
                change24h: parseFloat(t.chg24h) || 0
            };
        });
        return prices;
    } catch (error) {
